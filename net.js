...
(function () {
  ...
  // Adını yazmadan masaya oturulmaz; bot adlarından biri de seçilemez.
  function adTamam() {
    const ad = nameVal();
    if (ad.length < 2) {
    ...
    if (BOT_ADLARI.indexOf(ad.toLocaleLowerCase('tr')) >= 0) {
      note('“' + ad + '” bot adı, seçemezsin. Başka bir ad yaz.');
      const i = document.getElementById('lbName');
